...
public class UsuarioController {
    ...
    public ResponseEntity<List<UsuarioResumedResponseDTO>> buscarUsuariosPelaAutoEscolaEPeloPerfil(@PathVariable UUID autoEscolaId, @RequestParam(defaultValue = "ADMINISTRADOR") PerfilUsuario perfil) {
        return ResponseEntity.status(HttpStatus.OK).body(usuarioService.findAllByAutoEscolaIdAndPerfilUsuario(autoEscolaId, perfil));
    }
