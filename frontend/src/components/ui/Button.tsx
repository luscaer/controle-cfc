...
export function CustomButton({
  ...
  const variants = {
    primary:
      "bg-[#1C5B9E] text-white hover:bg-[#15467A] focus-visible:ring-[#1C5B9E]",
    secondary:
      "bg-transparent text-[#1C5B9E] border border-[#1C5B9E] hover:bg-blue-50 focus-visible:ring-[#1C5B9E]",
    ghost:
      "bg-transparent text-[#1C5B9E] hover:bg-blue-50 focus-visible:ring-blue-200",
  };
