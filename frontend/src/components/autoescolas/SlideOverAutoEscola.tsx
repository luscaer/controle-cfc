import { Building2, Calendar, CheckCircle, FileText, Lock, X, XCircle } from "lucide-react";
...
export function SlideOverAutoEscola({ id, aberto, onFechar }: SlideOverAutoEscolaProps) {
  const {
    register,
    handleSubmit,
    reset,
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Auto Escola</h1>
            <p className="text-xs text-gray-500 mt-0.5">Gerencie os dados da auto escola</p>
          </div>
          <CustomButton
            variant="ghost"
            onClick={fechar}
            ...
            <div className="px-6 py-6">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-br from-[#B5D4F4] to-[#85B7EB] border-[3px] border-white shadow-lg ring-2 ring-[#85B7EB]/30">
                  <Building2 className="h-8 w-8 text-[#0C447C]" strokeWidth={1.5} />
                </div>

                {/* Nome + Badge */}
                <h2 className="mt-3 text-base font-semibold text-gray-900">{dados.nome}</h2>
                <span
                ...
                >
                  {dados.ativo ? <CheckCircle size={11} /> : <XCircle size={11} />}
                  {dados.ativo ? "Ativa" : "Inativa"}
                </span>
                <p className="mt-1.5 text-xs text-gray-400">CNPJ: {aplicarMascaraCnpj(dados.cnpj)}</p>
              </div>
            </div>
              ...
              <div className="px-6 pt-5 pb-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <CustomInput
                      type="text"
                      value={new Date(dados.dataCriacao).toLocaleDateString("pt-BR", {
                        day: "2-digit",
                        month: "2-digit",
                        year: "numeric",
                        hour: "2-digit",
              ...
              <div className="px-6 pt-5 pb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <CustomInput
                      iconLeft={<Building2 className="h-4 w-4 text-gray-400" />}
                      type="text"
